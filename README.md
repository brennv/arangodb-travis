...
Write a chef [travis-cookbook](https://github.com/brennv/travis-cookbooks/add-arangodb) for general inclusion [here](https://docs.travis-ci.com/user/database-setup/).
